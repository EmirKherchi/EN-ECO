<template>
  <div class="Mentions">
    ...
    <b-container>
      ...
      <p>
        <strong>Propriétaire</strong> : EN ECO – SAS, société par actions
      ...
      <p>
        ...
        décidée par EN ECO, qui s’efforcera alors de communiquer préalablement
      ...
      <p>
        EN ECO est propriétaire des droits de propriété intellectuelle ou
      ...
      <p>
        ...
        l’espace contact) sont à la disposition des utilisateurs. EN ECO se
        ...
        protection des données. Le cas échéant, EN ECO se réserve également la
